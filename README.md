# Linve Sorter IntelliJ IDEA plugin
...
## Description
<!-- Plugin description -->
Line Sorter is a handy tool for developers that lets you quickly sort lines within a file or just within a selected area.
